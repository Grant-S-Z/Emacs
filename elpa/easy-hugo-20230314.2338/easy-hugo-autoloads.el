;;; easy-hugo-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
Generate figure shortcode." t nil)
...
Move image to image directory and generate figure shortcode." t nil)
...
Pull image from internet to image directory and generate figure shortcode." t nil)
...
Adapt local change to the server with hugo." t nil)
...
Preview hugo at localhost." t nil)

(autoload 'easy-hugo-current-time "easy-hugo" "\
Generate current time in date format at the frontmatter." t nil)
...
Execute `easy-hugo-github-deploy-script' script locate at `easy-hugo-basedir'." t nil)
...
Deploy hugo source at Amazon S3." t nil)
...
Deploy hugo source at Google Cloud Storage." t nil)
...
Auto-complete tags from your posts." t nil)

(autoload 'easy-hugo-complete-categories "easy-hugo" "\
Auto-complete categories from your posts." t nil)
